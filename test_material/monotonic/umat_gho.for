...
C
      SSEANISO=(K1/(TWO*K2))*(DEXP(K1*E1*E1)-ONE)
...
C      write(*,*) I4,I1
C      write(*,*)
C      write(*,*) SSEANISO, DUDI1,D2UD2I1,DUDI4, D2UD2I4,D2DUDI1DI4
C
      RETURN
...
C>     ISOTROPIC MATRIX : ISOCHORIC SEF AND DERIVATIVES - MOONEY RIVLIN MATRIX
      IMPLICIT NONE
      INCLUDE 'param_umat.inc'
C
