...
C     01/06/2016    Joao Ferreira      passive martins adapted      |
C     05/06/2016    Joao Ferreira      active martins added         |
C--------------------------------------------------------------------
C     Description:
...
C----------------------------------------------------------------------
          ACT=.5d0
c antes step
c*intial condition, type=field
c grupo de nos, valor inicial
cdentro do step
*field, variable=1, amplitude=curva de ativacao
**node_set. valor inicial/final
C----------------------------------------------------------------------
C
      IF((BARLAMBDA.GT.0.5d0).AND.(BARLAMBDA.LT.1.5d0)) THEN

C
         DUACT=ACT*T0M*(-4.0d0*E1**2.0d0+1.0d0)
C
