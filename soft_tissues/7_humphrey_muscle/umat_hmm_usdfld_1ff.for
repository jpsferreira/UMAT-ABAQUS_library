...
C
      PARAMETER(W=100.0d0,DZ=1.0d0)
      PARAMETER(PRESSURE=0.01d0)
...
C
     ...
     1 T(3,3),TIME(2)
      ...
      DOUBLE PRECISION CMNV(NUEL,NIPP,1)
C
...
C
      ...
      Z2=ZREF+DZ
C
      IF ((Z.GE.Z1).AND.(Z.LE.ZREF))THEN
      F=PRESSURE*((Z-Z1)/DZ)	
      ELSEIF ((Z.GE.ZREF).AND.(Z.LE.Z2))THEN
      F=-PRESSURE*((Z-ZREF)/DZ)+PRESSURE
      ELSE
      F=0
      END IF
      CMNV(NOEL,NPT,1)=F
...
C		 WRITE(*,*) DUACT, D2UACT, SSEANISO
      ELSE
         DUACT=ZERO
         D2UACT=ZERO
      SSEANISO=SSEANISO+ZERO
      END IF
C
c      DUDI4=DUDI4+DUACT
...
C
         ...
         DO I=1,NELEM
C           ATUALIZAR FICHEIRO FIBERS.INP DEPOIS !!!!!!!!!!!!!!**********
C            FIBORI(I,1)=I
C            FIBORI(I,2)=1.D0 
C            FIBORI(I,3)=0.D0
C            FIBORI(I,4)=0.D0         
