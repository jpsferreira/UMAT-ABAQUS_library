...
|----|-------|-----------|
| 0 | None | — |
| 1 | Affine (RW) | `[PHI, N, B_orient, EFI, pdir_x, pdir_y, pdir_z, L, R0, mu0, beta, B0, lambda0]` |
| 2 | Non-affine (RW) | `[PHI, N, B_orient, EFI, PP, L, R0, mu0, beta, B0, lambda0]` |
| 5 | Affine (AI) | `[PHI, N, B_orient, EFI, factor, pdir_x, pdir_y, pdir_z, L, R0, mu0, beta, B0, lambda0]` |
| 6 | Non-affine (AI) | `[PHI, N, PP, factor, L, R0, mu0, beta, B0, lambda0]` |
...
`NSTATEV = 1 + (2 if damage) + (9 * n_visco)`
