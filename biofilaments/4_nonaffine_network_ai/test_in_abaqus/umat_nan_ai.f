...
DOUBLE PRECISION :: filprops(6), naffprops(2)
DOUBLE PRECISION :: ll,lambda0,mu0,beta,nn,b0,bb
DOUBLE PRECISION :: phi,r0,p
...
DOUBLE PRECISION :: frac0(4),frac(4),kch(7),  &
...
!------------ AFFINE NETWORK --------------
IF (nn > zero) THEN
  CALL naffnetfic_discrete(snetficaf,cnetficaf,distgr,filprops,  &
...
END module globalSUBROUTINE bangle(ang,f,mf,noel,pdir,ndi)
