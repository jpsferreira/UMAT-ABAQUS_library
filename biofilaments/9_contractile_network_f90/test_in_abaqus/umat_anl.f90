...
SUBROUTINE material(sigma,statev,ddsigdde,dduddc,ddcddu, dfgrd0,dfgrd1,  &
    mutau,phi0,theta0,phit,phitau,dpdt,dphidmu,dphidotdmu,  &
    mob,dmdmu,dmdj,vmol,dmudx, time,dtime,predef,  &
    ndi,nshr,ntens,nstatev,props,nprops,coords,pnewdt, noel,npt,kstep,kinc)
...
DOUBLE PRECISION, INTENT(OUT)            :: dduddc(ndi,ndi)
DOUBLE PRECISION, INTENT(OUT)            :: ddcddu(ndi,ndi)
DOUBLE PRECISION, INTENT(IN OUT)         :: dfgrd0(3,3)
DOUBLE PRECISION, INTENT(IN OUT)         :: dfgrd1(3,3)
DOUBLE PRECISION, INTENT(IN OUT)         :: mutau
DOUBLE PRECISION, INTENT(IN OUT)         :: phi0
DOUBLE PRECISION, INTENT(IN OUT)         :: theta0
DOUBLE PRECISION, INTENT(IN OUT)         :: phit
DOUBLE PRECISION, INTENT(IN OUT)         :: phitau
DOUBLE PRECISION, INTENT(OUT)            :: dpdt
DOUBLE PRECISION, INTENT(OUT)            :: dphidmu
DOUBLE PRECISION, INTENT(OUT)            :: dphidotdmu
DOUBLE PRECISION, INTENT(OUT)            :: mob
DOUBLE PRECISION, INTENT(OUT)            :: dmdmu
DOUBLE PRECISION, INTENT(OUT)            :: dmdj
DOUBLE PRECISION, INTENT(IN OUT)         :: vmol
DOUBLE PRECISION, INTENT(IN OUT)         :: dmudx(ndi,1)
...
!     CHEMICAL DIFFUSION
DOUBLE PRECISION :: chi,d,mu0inf, rgas,dffprops(5)
DOUBLE PRECISION :: dete,dets,cr
