...
!      CALL AFFMATNETFIC(PKNETFICAF,CMNETFICAF,DISTGR,MF0,RW,FILPROPS,
!     1                         AFFPROPS,EFI,NOEL,DET,NDI)
  ! CALL affactnetfic_bazant(snetficaf,cnetficaf,distgr,mf0,rw,filprops,  &
  !     affprops,ru0,dtime,frac,efi,noel,varact,dirmax,det,ndi)
