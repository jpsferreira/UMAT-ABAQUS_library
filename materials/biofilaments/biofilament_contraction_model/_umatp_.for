...
C>--------------------------------------------------------------------
C>---------------------------------------------------------------------
      SUBROUTINE UMATP(STRESS,STATEV,DDSDDE,SSE,SPD,SCD,
...
C
      ...
      CALL INITIALIZE(STATEV,NWP,NCH,VV)
      ENDIF
C        READ STATEV
      CALL SDVREAD(FRAC0,RU0,STATEV,NWP,NCH,VV)
C----------------------------------------------------------------------
C---------------------------- KINEMATICS ------------------------------
C----------------------------------------------------------------------
...
C      CALL AFFNETFICP(SNETFICAF,CNETFICAF,DISTGR,MF0,RW,FILPROPS,
C     1                           AFFPROPS,RU0,DTIME,FRAC,EFI,DET,NDI)
...
C      STATEV(1:27) = VISCOUS TENSORS
       CALL SDVWRITE(FRAC,RU0,STATEV,NWP,NCH,VV)
C     END DO
C----------------------------------------------------------------------
      RETURN
      END
