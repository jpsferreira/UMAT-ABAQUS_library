...
C      CALL PUSH2(SANISOMATFIC,PKMATFICANISO,DISTGR,DET,NDI)
C      
      CALL CMATANISOMATFIC(CMANISOMATFIC,M0,DANISO,UNIT2,DET,NDI)
C      CALL PUSH4(CANISOMATFIC,CMANISOMATFIC,DISTGR,DET,NDI)
C----------------------------------------------------------------------
...
C      CAUCHY STRESS
C      CALL SIGVOL(SVOL,PV,UNIT2,NDI)
C
C---- ISOCHORIC -------------------------------------------------------
C      PK2 STRESS
      CALL PK2ISO(PKISO,PKFIC,PROJL,DET,NDI)
C      CAUCHY STRESS
CC      CALL SIGISO(SISO,SFIC,PROJE,NDI)
...
C---- VOLUMETRIC ------------------------------------------------------
C
C      CALL SETVOL(CVOL,PV,PPV,UNIT2,UNIT4S,NDI)
C
C---- ISOCHORIC -------------------------------------------------------
C
C      CALL SETISO(CISO,CFIC,PROJE,SISO,SFIC,UNIT2,NDI)
C
C----------------------------------------------------------------------
C
C     ELASTICITY TENSOR
C      DDSIGDDE=CVOL+CISO+CJR
C
C----------------------------------------------------------------------
C-------------------------- VISCOUS PART ------------------------------
C----------------------------------------------------------------------
...
C     END DO
!            write(*,*) 'siso'
!      write(*,*) SISO(1,1),SISO(1,2),SISO(1,3)
!      write(*,*) SISO(2,1),SISO(2,2),SISO(2,3)
!      write(*,*) SISO(3,1),SISO(2,2),SISO(3,3)
!            write(*,*) 'svol'
!      write(*,*) SVOL(1,1),SVOL(1,2),SVOL(1,3)
!      write(*,*) SVOL(2,1),SVOL(2,2),SVOL(2,3)
!      write(*,*) SVOL(3,1),SVOL(2,2),SVOL(3,3)
