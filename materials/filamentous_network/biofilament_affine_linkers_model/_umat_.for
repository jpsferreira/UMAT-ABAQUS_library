...
C     FILAMENTS NETWORK CONTRIBUTION
     ...
     1                 NAFFPROPS(2),AFFPROPS(2)
      DOUBLE PRECISION LL,R0F,LAMBDA0,MU0,BETA,NN,MM,B0,BB,PHI,P
      DOUBLE PRECISION R0C,ETAC
...
C      CALL CHEMICALSTAT(FRAC,FRAC0,KCH,DTIME)
C      frac(3)=0.214d0
C      frac(3)=0.d0
C      frac(4)=0.522d0
C      frac(4)=0.d0
C     MECHANICAL STATE FOR FILAMENT CONTRACTION
C
...
C      CALL NAFFNETFIC(SNETFICNAF,CNETFICNAF,DISTGR,MF0,RW,FILPROPS,
C     1                                   NAFFPROPS,DET,NDI)
C     
...
C      PKNETFIC=PKNETFICAF+PKNETFICNAF
      SNETFIC=SNETFICAF+SNETFICNAF
C      CMNETFIC=CMNETFICAF+CMNETFICNAF
      CNETFIC=CNETFICAF+CNETFICNAF
C----------------------------------------------------------------------
C     STRAIN-ENERGY
C      SSE=SSEV+SSEISO
